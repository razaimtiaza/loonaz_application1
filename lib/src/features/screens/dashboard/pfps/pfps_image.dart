...
class pfpsDetailScreen extends StatefulWidget {
  final List<PfpWallPaperData> imageDataList; // List of images
  ...
  @override
  _pfpsDetailScreenState createState() => _pfpsDetailScreenState();
}

class _pfpsDetailScreenState extends State<pfpsDetailScreen> {
  List<PaletteGenerator?> _paletteGenerators = [];
  int _currentIndex = 0;
  Color _backgroundColor = Colors.black;
  PfpWallPaperData _selectedItem = PfpWallPaperData();
  @override
  void initState() {
    super.initState();
